...
if __name__ == "__main__":
    ...
    rho = 0.901  # Supponiamo una correlazione media del 20%
    ...
    plt.xlabel('Mese')
    plt.ylabel('Numero di Default')
    plt.title('Distribuzione Temporale dei Default nei Prossimi 10 Anni (Mensile)')
    ...
    num_defaults = np.sum(monthly_defaults)
    print(f"Numero di default simulati nei prossimi 10 anni: {num_defaults}")